                            ...
                            <table id="table_id" class="table table-striped  table-striped table-border m-1 datatable-scroll-y">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pr-1 pl-1">{{$c->alamat}}</td>
                                        <td class="pr-1 pl-1">{{$c->nama_toko}}</td>
                                        <td class="pr-1 pl-1">{{$c->ktp}}</td>
                                        <td class="pr-1 pl-1">{{$c->pengiriman}}</td>
        ...
        $(document).on('click', '.editbtn', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    console.log(response.penjual.nama)
                    $('#nama').val(response.penjual.nama);
                    ...
                    $('#user_id').val(response.penjual.user_id);
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!--FORM UPDATE BARANG-->
                <form action="/penjual_update" method="post">
                    @csrf
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header text-center pb-3" style="background-color:#011126">
                ...
                <b<utton type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
